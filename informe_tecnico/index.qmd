...
El análisis revela varias limitaciones metodológicas. La función de recomendación por perfil no utiliza completamente la información disponible sobre tipo de destino y mejor momento para visitar, limitando su capacidad predictiva. Adicionalmente, la asignación de popularidad promedio para usuarios nuevos puede no reflejar preferencias individuales reales.
